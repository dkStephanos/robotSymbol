...
/// <summary>
/// Initializes a new instance of the <see cref="SpaceShuttle"/> class.
/// </summary>
/// <param name="name">The name.</param>
SpaceShuttle::SpaceShuttle(const string& name, float scaler) :
	OGL3DObject(name) 
{
...
/// <summary>
/// Updates at the specified elapsed time ms.
/// </summary>
/// <param name="elapsedTimeMS">The elapsed time ms.</param>
void SpaceShuttle::update(float elapsedTimeMS)
{
	if (this->behavior) {
...
/// <summary>
/// Finalizes an instance of the <see cref="SpaceShuttle"/> class.
/// </summary>
...
/// <summary>
/// Launches the space shuttle by setting the behavior to the appropriate state.
/// </summary>
void SpaceShuttle::launch()
{
	SpaceShuttleBehavior* sb = (SpaceShuttleBehavior*)this->behavior;

	sb->setState(SpaceShuttleBehavior::MOVING_UP);
}

void SpaceShuttle::generate(float scaler)
{
